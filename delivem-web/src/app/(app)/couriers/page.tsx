        ...
        <div className="flex flex-col gap-3">
          {(couriers as (Profile & { courier_profile: CourierProfile | null })[])
            ...
            .map((courier) => {
              ...
              const transport = cp?.transport_type
                ? TRANSPORT_META[cp.transport_type]
                : null
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                          <span
                            ...
                            style={{ color: '#757682', fontSize: 14 }}
                          >
                            location_on
                          </span>
                        ...
                        {courier.bio && (
                          <p
                            ...
                            style={{ color: '#757682', maxWidth: 300 }}
                          >
                            {courier.bio}
                          </p>
                        )}
                      ...
                      <div className="text-right flex-shrink-0 ml-4">
                        <div className="flex items-center gap-1">
                          ...
                          <span
                            className="material-symbols-outlined fill-icon text-xs"
...
// Client component for toggling favorites
  ...
  return (
    <form
      action={async () => {
        ...
        if (isFav) {
          ...
          await supabase
            .from('favorite_couriers')
            .insert({ customer_id: customerId, courier_id: courierId })
        }
    ...
    >
      <button
        ...
        style={{ color: isFav ? '#ba1a1a' : '#c5c5d3' }}
      >
