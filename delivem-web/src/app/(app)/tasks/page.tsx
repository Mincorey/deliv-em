...
async function CourierFeed({
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      {/* Filters */}
      <div
        className="glass rounded-2xl p-4 mb-5 flex flex-wrap gap-3"
      >
        <form className="flex flex-wrap gap-3 w-full">
          ...
          <div>
            ...
            <input
              type="number"
              name="min_reward"
              defaultValue={params.min_reward}
              placeholder="₽"
              className="input-field text-xs"
          ...
          <div className="flex items-end">
            <button type="submit" className="btn-ghost text-xs" style={{ padding: '8px 16px' }}>
              Применить
            </button>
          </div>
        </form>
